...
* 自v0.8.6支持**Xmind和MindManager**格式导入，并且支持带入他们的images, links, notes, markers, lables, priority, progress。

* 自v0.8.2以后实现本地图片的上传功能。

* 多语言国际化现在支持英语、简体中文、繁體中文、日语、西班牙语、法语、德语。
    
* 支持多语言的切换，在工具->选项->插件->Kminder Mindmap下调整。
