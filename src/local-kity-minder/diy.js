(function(){
	...
	html += '<a class="diy export" data-type="markdown">'+_lang_pack[_lang_default]['panels']['export']+'MD</a>',
	...
	//html += '<a class="diy export" name="btn_export_km" data-type="json">'+_lang_pack[_lang_default]['panels']['export']+'KM</a>',
	html += '<button class="diy input">'+_lang_pack[_lang_default]['panels']['import']+'<input type="file" id="fileInput"></button>';
	...
	*/
	...
	window.onload = function() {
		...
		//	save_file(get_datatime_by_yyyyMMddhhmmss_without_split(), parent.value);
		//});
